      ...
      <div className="bg-white p-8 rounded-[2.5rem] shadow-xl max-w-md w-full border border-slate-100 animate-fade-in relative overflow-hidden">
        ...
        <form onSubmit={handleAuth} className="space-y-4 relative z-10">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-orange-500/20 focus:bg-white outline-none text-slate-900 transition-all font-medium"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-slate-900 text-white rounded-2xl font-black text-xs tracking-widest uppercase hover:bg-slate-800 transition-all flex items-center justify-center gap-3 shadow-xl hover:scale-[1.02] active:scale-95 disabled:opacity-50"
          >
        ...
        <div className="mt-6 text-center space-y-6 relative z-10">
          <button
            ...
            className="text-[10px] text-slate-400 hover:text-orange-500 font-black uppercase tracking-widest transition-colors"
          >
          ...
          <div className="flex flex-col gap-3 pt-6 border-t border-slate-100">
             <button 
                ...
                className="w-full py-4 bg-white border-2 border-orange-500 text-orange-500 rounded-2xl font-black text-xs tracking-widest uppercase hover:bg-orange-50 transition-all flex items-center justify-center gap-3 shadow-sm hover:scale-[1.02]"
             >
