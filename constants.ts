...
export const INITIAL_EXERCISES: Exercise[] = [
  ...
  // --- PANIER DE BALLES (PB1-PB20) ---
  { id: 'pb1', name: 'PB - Initiation Topspin CD', phase: 'technique', theme: 'Topspin', duration: 15, description: 'Balles coupées envoyées en CD. Focus sur l\'ouverture de raquette et le frotté bas-vers-haut. Le joueur doit finir son geste à l\'œil gauche.', material: 'Panier de balles' },
  { id: 'pb2', name: 'PB - Falkenberg (Rythme)', phase: 'deplacement', theme: 'Jeu de jambes', duration: 15, description: 'Séquence rapide : 1 Revers -> 1 Pivot CD -> 1 Plein CD. Le coach régule la vitesse pour pousser le joueur à la limite.', material: 'Panier de balles' },
  { id: 'pb3', name: 'PB - Flip Revers sur balle courte', phase: 'technique', theme: 'Flip', duration: 12, description: 'Distribution balle courte coupée ou molle dans le revers. Le joueur doit avancer le pied, entrer dans la table et flipper.', material: 'Panier de balles' },
  { id: 'pb4', name: 'PB - Incertitude Milieu / CD', phase: 'technique', theme: 'Incertitude', duration: 15, description: 'Distribution aléatoire entre le ventre (coude) et le plein CD. Travail du petit pas d\'ajustement pour dégager le bras.', material: 'Panier de balles' },
  { id: 'pb5', name: 'PB - Topspin CD sur coupes variées', phase: 'technique', theme: 'Topspin', duration: 15, description: 'Le coach varie la longueur et l\'intensité de la coupe (courte, longue, très taillée, molle). Le joueur doit lire l\'effet.', material: 'Panier de balles' },
  { id: 'pb6', name: 'PB - V-Inversé (Cardio)', phase: 'deplacement', theme: 'Jeu de jambes', duration: 10, description: 'Distribution : Plein CD -> Milieu -> Plein RV -> Milieu. Rythme soutenu. Focus sur le retour au centre après chaque coup.', material: 'Panier de balles' },
  { id: 'pb7', name: 'PB - Prise d\'initiative (Service/Remise)', phase: 'schema', theme: 'Remise de service', duration: 15, description: 'Le joueur sert à vide, le coach envoie une balle simulant une remise longue. Le joueur doit démarrer fort (3ème balle).', material: 'Panier de balles' },
  { id: 'pb8', name: 'PB - Bloc Actif sous pression', phase: 'technique', theme: 'Bloc', duration: 12, description: 'Le coach simule des topspins rapides (balles frappées). Le joueur doit tenir le bloc sans reculer et essayer de diriger la balle.', material: 'Panier de balles' },
  { id: 'pb9', name: 'PB - Smash sur balle haute', phase: 'technique', theme: 'Contre-initiative', duration: 10, description: 'Le coach envoie des balles hautes (lobs) en fond de court. Travail du recul, de l\'armé du bras et du smash.', material: 'Panier de balles' },
  { id: 'pb10', name: 'PB - Contre-Top à mi-distance', phase: 'technique', theme: 'Contre-initiative', duration: 15, description: 'Balles liftées envoyées loin de la table. Le joueur doit re-toper sur la balle avec une grande amplitude.', material: 'Panier de balles' },
  
  // NOUVEAUX PB AJOUTÉS
  { id: 'pb11', name: 'PB - Le "8" (Jeu de jambes)', phase: 'deplacement', theme: 'Jeu de jambes', duration: 15, description: 'Le coach envoie Ligne Droite puis Diagonale alternativement. Le joueur doit croiser (jouer ligne droite) sur chaque balle. Déplacement constant.', material: 'Panier de balles' },
  { id: 'pb12', name: 'PB - Flip Coup Droit', phase: 'technique', theme: 'Flip', duration: 12, description: 'Balles courtes coupées dans le coup droit. Le joueur doit passer la jambe droite sous la table et accélérer avec le poignet.', material: 'Panier de balles' },
  { id: 'pb13', name: 'PB - Défense coupée (Chopping)', phase: 'technique', theme: 'Contre-initiative', duration: 15, description: 'Le coach envoie des topspins rapides. Le joueur recule et défend en coupant la balle (geste descendant).', material: 'Panier de balles' },
  { id: 'pb14', name: 'PB - Liaison Topspin RV / Topspin CD', phase: 'technique', theme: 'Topspin', duration: 15, description: 'Une balle en Revers (Topspin), une balle en CD (Topspin). Focus sur la transition et la rotation du tronc.', material: 'Panier de balles' },
  { id: 'pb15', name: 'PB - "Essuie-Glace" Aléatoire', phase: 'deplacement', theme: 'Incertitude', duration: 12, description: 'Distribution aléatoire sur toute la largeur de la table. Le joueur doit tout jouer en Coup Droit. Très physique.', material: 'Panier de balles' },
  { id: 'pb16', name: 'PB - Démarrage sur balle "Molle"', phase: 'technique', theme: 'Topspin', duration: 15, description: 'Le coach envoie des balles sans effet (molles). Le joueur doit créer tout l\'effet (ne pas s\'appuyer sur la vitesse adverse).', material: 'Panier de balles' },
  { id: 'pb17', name: 'PB - Pivot + Finition Ligne Droite', phase: 'schema', theme: 'Jeu de jambes', duration: 15, description: 'Balle dans le revers -> Pivot -> Frappe gagnante long de ligne. Recherche de la zone KO.', material: 'Panier de balles' },
  { id: 'pb18', name: 'PB - Bloc Latéral "Pressé"', phase: 'technique', theme: 'Bloc', duration: 10, description: 'Le coach "mitraille" le revers du joueur. Le joueur doit bloquer actif en variant le placement (gauche/droite).', material: 'Panier de balles' },
  { id: 'pb19', name: 'PB - Service + 3ème + 5ème balle', phase: 'schema', theme: 'Tactique', duration: 20, description: 'Le joueur sert. Coach remet long. Joueur Topspin (3e). Coach bloque. Joueur Frappe (5e). Séquence scriptée.', material: 'Panier de balles' },
  { id: 'pb20', name: 'PB - La "Virgule" (Chiquita)', phase: 'technique', theme: 'Flip', duration: 15, description: 'Balles courtes variées. Le joueur doit réaliser un flip revers avec effet latéral sortant (banane).', material: 'Panier de balles' },
  ...
  { id: 'd2', name: 'Le Tiroir (Avant-Arrière)', phase: 'deplacement', theme: 'Jeu de jambes', duration: 15, description: 'Alternance balle très courte / balle très profonde. Oblige à fendre vers l\'avant puis repousser fort vers l\'arrière.', material: 'Panier de balles' },
  { id: 'd3', name: 'Falkenberg "Jambes seules"', phase: 'deplacement', theme: 'Jeu de jambes', duration: 20, description: 'Séquence : Revers -> Pivot -> CD. Focus uniquement sur la vitesse de replacement et l\'équilibre, sans frapper fort.', material: 'Balles' },
  { id: 'd4', name: 'Pivot + Grand Écart', phase: 'deplacement', theme: 'Jeu de jambes', duration: 15, description: '1 Topspin Pivot (coin revers) suivi immédiatement d\'une balle grand côté CD. Nécessite une impulsion explosive.', material: 'Balles' },
  { id: 'd5', name: 'Pas croisés défensifs', phase: 'deplacement', theme: 'Jeu de jambes', duration: 15, description: 'Sur une balle très excentrée, le joueur doit croiser les jambes pour gagner de l\'allonge et récupérer la balle.', material: 'Panier de balles' },
  { id: 'd6', name: 'Multiballes Aléatoire "Survie"', phase: 'deplacement', theme: 'Incertitude', duration: 10, description: 'Le coach envoie des balles à un rythme élevé partout sur la table. Le but est juste de toucher la balle (réaction pure).', material: 'Panier de balles' },
  { id: 'd7', name: 'Service + Reprise d\'appuis', phase: 'deplacement', theme: 'Service', duration: 15, description: 'Le joueur sert, touche ses genoux (ou un plot au sol) et se met en position de base. Travail de l\'activation post-service.', material: 'Balles' },
  { id: 'd8', name: 'Shadow "Lumière"', phase: 'deplacement', theme: 'Jeu de jambes', duration: 10, description: 'Le coach pointe une zone avec la raquette. Le joueur doit s\'y déplacer instantanément et mimer un coup (Shadow).', material: 'Aucun' },
  { id: 'd9', name: 'Echelle de rythme (Coordination)', phase: 'deplacement', theme: 'Physique', duration: 15, description: 'Exercices au sol avec échelle : pas rapides, in & out, cloche-pied. Améliore la fréquence des appuis.', material: 'Echelle de rythme' },
  { id: 'd10', name: 'Squats sautés + Démarrage', phase: 'deplacement', theme: 'Physique', duration: 10, description: '3 squats sautés hors table, puis sprint vers la table pour jouer une balle envoyée par le coach.', material: 'Balles' },
  { id: 'd11', name: 'Pas d\'ajustement (Micro-placement)', phase: 'deplacement', theme: 'Jeu de jambes', duration: 15, description: 'Balles envoyées sur le coude (ventre). Le joueur doit faire un tout petit décalage pour jouer en CD ou RV.', material: 'Panier de balles' },
  { id: 'd12', name: 'La "Croix" (4 coins)', phase: 'deplacement', theme: 'Jeu de jambes', duration: 20, description: 'Enchaînement : CD court -> CD fond -> RV fond -> RV court. Couvre toute la surface de jeu.', material: 'Balles' },
  { id: 'd13', name: 'Déplacement "Crabe" (Bloc)', phase: 'deplacement', theme: 'Bloc', duration: 15, description: 'Bloc coup droit continu en se déplaçant latéralement sur toute la largeur de la table.', material: 'Balles' },
  { id: 'd14', name: 'Fente avant (Remise courte)', phase: 'deplacement', theme: 'Jeu de jambes', duration: 15, description: 'Départ position reculée. Sur balle courte, faire une grande fente avant (pied droit pour droitier) pour passer sous la table.', material: 'Balles' },
  { id: 'd15', name: 'Course arrière (Lob)', phase: 'deplacement', theme: 'Contre-initiative', duration: 15, description: 'Démarrage à la table. Au signal, reculer le plus vite possible (4-5m) pour jouer une balle haute.', material: 'Balles' },
  { id: 'd16', name: '1 pas, 1 coup (Rythme)', phase: 'deplacement', theme: 'Jeu de jambes', duration: 15, description: 'Chaque coup doit être accompagné d\'un petit saut d\'allègement. Interdiction de jouer "planté" au sol.', material: 'Balles' },
  { id: 'd17', name: 'Pas chassés avec résistance', phase: 'deplacement', theme: 'Physique', duration: 10, description: 'Déplacements latéraux avec un élastique autour de la taille retenu par un partenaire. Renforcement musculaire.', material: 'Élastique' },
  { id: 'd18', name: 'Jeu de jambes "Essuie-glace"', phase: 'deplacement', theme: 'Jeu de jambes', duration: 15, description: 'Séquence rapide : Milieu -> Plein CD -> Milieu -> Plein CD. Toujours en coup droit.', material: 'Panier de balles' },
  { id: 'd19', name: 'Rotation du buste + Replacement', phase: 'deplacement', theme: 'Physique', duration: 15, description: 'Exécuter un Topspin à vide avec rotation maximale du tronc, revenir position neutre, recommencer. Sans balle.', material: 'Médecine ball (optionnel)' },
  { id: 'd20', name: 'Circuit Training Ping', phase: 'deplacement', theme: 'Physique', duration: 25, description: 'Atelier 1: Corde. Atelier 2: Abdos. Atelier 3: Pas chassés. Atelier 4: Panier de balles. 45sec par atelier.', material: 'Chrono, Tapis' },
