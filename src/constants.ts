...
const generateExercises = (): Exercise[] => {
  return [
    ...
    { id: 'pb_t8', name: "Top RV on Balle Coupée", phase: "panier", theme: "Revers (RV)", duration: 15, description: "Distribution de balles coupées sur le revers. Le joueur doit démarrer en topspin revers avec un bon engagement du poignet.", material: "Panier de balles", level: 'avance' },
    ...
    // --- TECHNIQUE ---
    { id: 'tech_beg_top1', name: "Initiation Top CD - L'Ascenseur", phase: "technique", theme: "Topspin", duration: 15, description: "Apprendre à remonter la balle de bas en haut sans force excessive. Focus on l'action verticale.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top2', name: "Top CD on Balle Portée", phase: "technique", theme: "Topspin", duration: 15, description: "L'entraîneur porte la balle, le débutant doit venir 'frotter' le dessus pour sentir l'accroche.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top3', name: "Top CD Cible au Centre", phase: "technique", theme: "Topspin", duration: 20, description: "Viser une zone large au milieu de la table pour sécuriser le geste et la trajectoire.", material: "Balles + Cible", level: 'debutant' },
    { id: 'tech_beg_top4', name: "Top CD vs Poussette Haute", phase: "technique", theme: "Topspin", duration: 20, description: "Apprendre à lifter une balle qui a peu d'effet mais qui est basse. Travail du timing.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top5', name: "Top CD Rythme Métronome", phase: "technique", theme: "Topspin", duration: 15, description: "Enchaîner 5 tops à vitesse constante sans chercher la puissance. Focus on la régularité du geste.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top6', name: "Top CD Sortie de Raquette", phase: "technique", theme: "Topspin", duration: 15, description: "Focus on le contact balle-raquette pour sentir l'accroche et la rotation.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top7', name: "Top CD après Pas Chassé", phase: "technique", theme: "Topspin", duration: 20, description: "Un petit pas on le côté puis déclenchement du geste. Coordination bas/haut du corps.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top8', name: "Top CD Trajectoire Courbe", phase: "technique", theme: "Topspin", duration: 15, description: "Essayer de faire passer la balle haut au-dessus du filet pour assurer le passage.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top9', name: "Top CD vs Bloc de l'Entraîneur", phase: "technique", theme: "Topspin", duration: 20, description: "L'entraîneur bloque doucement, le joueur essaie de garder la balle on la table en frottant.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top10', name: "Top CD Finition Épaule", phase: "technique", theme: "Topspin", duration: 15, description: "Vérifier que la raquette finit bien au niveau de l'épaule opposée pour un geste complet.", material: "Balles", level: 'debutant' },
    ...
    { id: 'ch_t_lud5', name: "Le Bowling du Ping", phase: "technique", theme: "Topspin", duration: 20, description: "Ludique : Aligner 6 gobelets en plastique on la ligne de fond. Le joueur doit les renverser en Topspin. Strike = 10 pts.", material: "Gobelets", level: 'debutant' },
    { id: 'ch_t1', name: "Service Court Latéral-Lifté", phase: "technique", theme: "Service", duration: 15, description: "Travailler le service court avec effet latéral et lifté. La balle doit rebondir deux fois on le camp adverse.", material: "Balles", level: 'intermediaire' },
    { id: 'ch_t2', name: "Flip Revers on Balle Courte", phase: "technique", theme: "Flip", duration: 20, description: "Attaque de revers on une balle courte et peu coupée. Focus on l'engagement du poignet.", material: "Balles", level: 'avance' },
    { id: 'ch_t3', name: "Topspin CD on Balle Coupée", phase: "technique", theme: "Topspin", duration: 20, description: "Démarrage en coup droit on une poussette longue coupée. Utilisation des jambes pour remonter la balle.", material: "Balles", level: 'intermediaire' },
    { id: 'ch_t4', name: "Pivot Coup Droit Explosif", phase: "technique", theme: "Coup Droit (CD)", duration: 15, description: "Se décaler en pivot pour attaquer en coup droit depuis le plein revers. Focus on la vitesse de placement.", material: "Balles", level: 'avance' },
    { id: 'ch_t5', name: "Remise de Service Poussette Active", phase: "technique", theme: "Remise de service", duration: 15, description: "Remise longue et agressive on un service coupé. La balle doit être profonde et rapide.", material: "Balles", level: 'intermediaire' },
    ...
    { id: 'ch_t7', name: "Topspin RV Ligne de Fond", phase: "technique", theme: "Revers (RV)", duration: 20, description: "Topspin de revers visant la ligne de fond adverse. Focus on la profondeur de balle.", material: "Balles", level: 'avance' },
    ...
    { id: 'ch_t9', name: "Flip Coup Droit (Banane CD)", phase: "technique", theme: "Flip", duration: 20, description: "Attaque de coup droit on balle courte avec un mouvement de 'banane' pour contourner la balle.", material: "Balles", level: 'pro' },
    ...
    { id: 'ch_s_beg10', name: "Attaque on Balle Haute", phase: "schema", theme: "Habileté", duration: 15, description: "Le partenaire envoie une balle haute (lob). Le débutant doit finir le point avec un geste descendant.", material: "Balles", level: 'debutant' },
    ...
    { id: 'ch_c6', name: "Lecture de Rotation Flash", phase: "cognitif", theme: "Perception", duration: 15, description: "L'entraîneur sert avec beaucoup d'effet. Le joueur doit annoncer l'effet (Coupé, Lifté, Latéral) AVANT que la balle ne rebondisse on son camp.", material: "Balles", level: 'pro' },
