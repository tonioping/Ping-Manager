...
const generateExercises = (): Exercise[] => {
  return [
    ...
    { id: 'ch_c11', name: "Simon Says Ping", phase: "cognitif", theme: "Inhibition", duration: 10, description: "Ludique : Le coach donne des ordres de coups. Le joueur ne doit exécuter que si le coach dit 'Simon dit'. Sinon, il doit bloquer passivement.", material: "Balles", level: 'debutant' },
    ...
    { id: 'flip_adv2', name: "Flip en Reculade", phase: "technique", theme: "Flip", duration: 20, description: "Le joueur recule de la table (2-3 pas en arrière) puis exécute un flip sur une balle lancée vers lui. Travail de la lecture et de la réactivité.", material: "Balles", level: 'avance' },
