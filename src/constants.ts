...
const generateExercises = (): Exercise[] => {
  return [
    ...
    { id: 'ch_r3', name: "Liaison 1-1 (CD/RV)", phase: "regularite", theme: "Coordination", duration: 15, description: "Intermédiaire : Alterner 1 coup droit et 1 revers on le revers adverse. Focus on le transfert de poids.", material: "Balles", level: 'intermediaire' },
    { id: 'ch_r4', name: "Huit de Chiffre (Classique)", phase: "regularite", theme: "Régularité", duration: 20, description: "Joueur A joue toujours en ligne, Joueur B joue toujours en diagonale. Dessine un 8 on la table.", material: "Balles", level: 'intermediaire' },
    ...
    { id: 'ch_r5', name: "Le Triangle de Placement", phase: "regularite", theme: "Placement", duration: 20, description: "Intermédiaire : Joueur A distribue en RV. Joueur B alterne : 1 CD coin, 1 CD milieu, 1 CD coin. Focus on le replacement.", material: "Balles", level: 'intermediaire' },
    ...
    { id: 'ch_r8', name: "Contre-Top de Contrôle", phase: "regularite", theme: "Topspin", duration: 15, description: "Intermédiaire : À mi-distance, les deux joueurs font du topspin on topspin à vitesse modérée. Focus on la courbe.", material: "Balles", level: 'avance' },

    // --- TECHNIQUE ---
    { id: 'ch_t_beg1', name: "Apprentissage Geste CD", phase: "technique", theme: "Coup Droit (CD)", duration: 20, description: "Décomposition du geste de coup droit. Focus on l'ouverture de la raquette et la fin de geste au front.", material: "Balles", level: 'debutant' },
    { id: 'ch_t_beg2', name: "Apprentissage Geste RV", phase: "technique", theme: "Revers (RV)", duration: 20, description: "Décomposition du geste de revers. Focus on l'action du coude et l'accompagnement vers l'avant.", material: "Balles", level: 'debutant' },
    ...
    { id: 'ch_t_int1', name: "Topspin CD sur Bloc", phase: "technique", theme: "Topspin", duration: 20, description: "Intermédiaire : Enchaîner des topspins CD on un bloc passif. Focus on le replacement et la jambe d'appui.", material: "Balles", level: 'intermediaire' },
