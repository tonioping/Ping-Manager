...
const generateExercises = (): Exercise[] => {
  return [
    ...
    { id: 'tech_beg_game4', name: "Duel des Zones (A4)", phase: "technique", theme: "Topspin", duration: 20, description: "Placer 2 feuilles A4 dans les corners. L'entraîneur annonce 'Gauche' ou 'Droite' au dernier moment. Toucher la feuille = 2 pts.", material: "2 Feuilles A4", level: 'debutant' },
    ...
    { id: 'tech_cd_beg1', name: "Le Toboggan du Coup Droit", phase: "technique", theme: "Coup Droit (CD)", duration: 15, description: "Apprendre l'inclinaison de la raquette. Faire glisser la balle sur la raquette inclinée avant de la frapper doucement vers l'avant.", material: "Balles", level: 'debutant' },
    { id: 'tech_cd_beg2', name: "Cible Mobile CD", phase: "technique", theme: "Coup Droit (CD)", duration: 20, description: "L'entraîneur déplace une cible (boîte) sur la table. Le joueur doit essayer de la toucher avec un coup droit simple.", material: "Boîte de balles", level: 'debutant' },
    { id: 'tech_cd_beg3', name: "Le Balancier CD", phase: "technique", theme: "Coup Droit (CD)", duration: 15, description: "Focus sur le transfert de poids. Balancer le corps d'une jambe sur l'autre en effectuant le geste du coup droit sans balle, puis avec balle.", material: "Balles", level: 'debutant' },
    
    // --- NOUVEAUX EXERCICES TECHNIQUE COUP DROIT INTERMÉDIAIRE ---
    { id: 'tech_cd_int1', name: "Top CD en Ligne vs Bloc", phase: "technique", theme: "Coup Droit (CD)", duration: 20, description: "Le partenaire bloque en revers. Le joueur doit toper en coup droit uniquement dans la ligne droite. Focus sur l'orientation des épaules.", material: "Balles", level: 'intermediaire' },
    { id: 'tech_cd_int2', name: "Top CD après Pivot", phase: "technique", theme: "Coup Droit (CD)", duration: 20, description: "Le partenaire distribue sur le revers. Le joueur pivote et tope en coup droit. Focus sur la vitesse du premier pas et l'équilibre.", material: "Balles", level: 'intermediaire' },
    { id: 'tech_cd_int3', name: "Top CD avec Variation d'Effet", phase: "technique", theme: "Coup Droit (CD)", duration: 20, description: "L'entraîneur envoie des balles régulières. Le joueur doit alterner : un top très frotté (lent/courbe) et un top frappé (rapide/tendu).", material: "Balles", level: 'intermediaire' },
    { id: 'tech_cd_int4', name: "Contre-Top à la Table (Initiation)", phase: "technique", theme: "Coup Droit (CD)", duration: 15, description: "Le partenaire fait un top lent. Le joueur doit contrer avec un geste court au sommet du rebond. Utiliser la vitesse adverse.", material: "Balles", level: 'intermediaire' },
