...
const generateExercises = (): Exercise[] => {
  return [
    ...
    { id: 'ch_d_beg8', name: "Le Serpent de Table", phase: "deplacement", theme: "Agilité", duration: 10, description: "Le joueur longe la table en pas chassés (avant/arrière) tout in jonglant avec sa balle. Interdiction de faire tomber la balle.", material: "Raquette + Balle", level: 'debutant' },
