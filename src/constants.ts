...
const generateExercises = (): Exercise[] => {
  return [
    ...
    // --- JEU DE JAMBES (TECHNIQUE) ---
    { id: 'tech_jj_1', name: "Le Pas Chassé Latéral Rapide", phase: "technique", theme: "Jeu de jambes", duration: 15, description: "Face au filet, déplacements latéraux rapides sur 3 positions (gauche-centre-droite) en gardant toujours les pieds parallèles. Focus sur la vitesse de réaction et le retour au centre.", material: "Aucun", level: 'debutant' },
    { id: 'tech_jj_2', name: "Le Croisé Avancé (Crossover Step)", phase: "technique", theme: "Jeu de jambes", duration: 20, description: "Déplacement en croisé pour atteindre les balles lointaines : pied gauche croise devant pour aller à droite, et inversement. Exercé en shadow play puis avec balle.", material: "Balles", level: 'intermediaire' },
    { id: 'tech_jj_3', name: "Le Petit Pas de Réglage", phase: "technique", theme: "Jeu de jambes", duration: 15, description: "Après un grand déplacement, effectuer 1 à 3 petits pas rapides pour se repositionner précisément avant de frapper. Travail du timing et de la précision du dernier pas.", material: "Balles", level: 'intermediaire' },
    { id: 'tech_jj_4', name: "La Récupération en Arrière (Backstep)", phase: "technique", theme: "Jeu de jambes", duration: 20, description: "Reculer rapidement de la table après un coup d'attaque pour se replacer en position de sécurité. Le dernier pas doit être un pas croisé pour pivoter et faire face au jeu.", material: "Balles", level: 'avance' },
    { id: 'tech_jj_5', name: "Le Pivot Pied Gauche", phase: "technique", theme: "Jeu de jambes", duration: 15, description: "Pivot sur le pied gauche pour tourner le corps et libérer l'espace du coup droit. Travail de l'amplitude de rotation et de l'équilibre sur un appui unique.", material: "Aucun", level: 'intermediaire' },
    { id: 'tech_jj_6', name: "Le Pivot Pied Droit", phase: "technique", theme: "Jeu de jambes", duration: 15, description: "Pivot sur le pied droit pour se préparer au revers. Le poids du corps bascule de l'avant vers l'arrière. Focus sur la stabilité et la vitesse de rotation.", material: "Aucun", level: 'intermediaire' },
    { id: 'tech_jj_7', name: "Le Saut Latéral (Split Step)", phase: "technique", theme: "Jeu de jambes", duration: 15, description: "Petit saut à deux pieds au moment où l'adversaire frappe la balle. Ce split step permet de réagir instantanément dans n'importe quelle direction.", material: "Aucun", level: 'debutant' },
    { id: 'tech_jj_8', name: "Déplacement Cercle Complet", phase: "technique", theme: "Jeu de jambes", duration: 20, description: "Autour d'un point central, le joueur se déplace en cercle complet (horaire puis antihoraire) en maintenant une position basse. Développe l'agilité et l'endurance des jambes.", material: "Aucun", level: 'avance' },
    { id: 'tech_jj_9', name: "Le Pas Chassé en Avant-Recul", phase: "technique", theme: "Jeu de jambes", duration: 15, description: "Alternance de pas chassés vers l'avant (vers la table) et vers l'arrière (loin de la table). Travail du changement de rythme et de la lecture de la profondeur.", material: "Balles", level: 'intermediaire' },
    { id: 'tech_jj_10', name: "Le Décroisé de Sauvetage", phase: "technique", theme: "Jeu de jambes", duration: 20, description: "Quand la balle est très large, le joueur doit effectuer un décroisement de jambes (pied d'appui croise derrière) pour revenir frapper une balle quasi impossible. Exercé au ralenti puis en vitesse.", material: "Balles", level: 'avance' },
