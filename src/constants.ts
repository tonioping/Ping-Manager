...
const generateExercises = (): Exercise[] => {
  return [
    ...
    { id: 'ch_t_lud6', name: "Top CD 'Ligne de Mire'", phase: "technique", theme: "Topspin", duration: 20, description: "Placer une bouteille au milieu de la ligne de fond. Le joueur doit réaliser 5 Top CD consécutifs qui passent à moins de 20cm de la bouteille.", material: "Bouteille / Plot", level: 'pro' },
    { id: 'ch_t_lud7', name: "Poussette 'Stop ou Encore'", phase: "technique", theme: "Poussette", duration: 15, description: "Poussette RV croisée. Au signal 'STOP', le joueur doit amortir la balle pour qu'elle soit la plus courte possible. Travail du toucher.", material: "Balles", level: 'debutant' },
