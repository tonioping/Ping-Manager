...
const generateExercises = (): Exercise[] => {
  return [
    ...
    { id: 'ch_s_beg10', name: "Attaque sur Balle Haute", phase: "schema", theme: "Habileté", duration: 15, description: "Le partenaire envoie une balle haute (lob). Le débutant doit finir le point with un geste descendant.", material: "Balles", level: 'debutant' },
    ...
    { id: 'ch_c6', name: "Lecture de Rotation Flash", phase: "cognitif", theme: "Perception", duration: 15, description: "L'entraîneur sert with beaucoup d'effet. Le joueur doit annoncer l'effet (Coupé, Lifté, Latéral) AVANT que la balle ne rebondisse sur son camp.", material: "Balles", level: 'pro' },
