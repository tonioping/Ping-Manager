...
const generateExercises = (): Exercise[] => {
  return [
    ...
    // --- TECHNIQUE ---
    { id: 'tech_beg_top1', name: "Initiation Top CD - L'Ascenseur", phase: "technique", theme: "Topspin", duration: 15, description: "Apprendre à remonter la balle de bas en haut sans force excessive. Focus sur l'action verticale.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top2', name: "Top CD sur Balle Portée", phase: "technique", theme: "Topspin", duration: 15, description: "L'entraîneur porte la balle, le débutant doit venir 'frotter' le dessus pour sentir l'accroche.", material: "Balles", level: 'debutant' },
    ...
    { id: 'tech_beg_top5', name: "Top CD Rythme Métronome", phase: "technique", theme: "Topspin", duration: 15, description: "Enchaîner 5 tops à vitesse constante sans chercher la puissance. Focus sur la régularité du geste.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top6', name: "Top CD Sortie de Raquette", phase: "technique", theme: "Topspin", duration: 15, description: "Focus sur le contact balle-raquette pour sentir l'accroche et la rotation.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_top7', name: "Top CD après Pas Chassé", phase: "technique", theme: "Topspin", duration: 20, description: "Un petit pas sur le côté puis déclenchement du geste. Coordination bas/haut du corps.", material: "Balles", level: 'debutant' },
    ...
    { id: 'tech_beg_top9', name: "Top CD vs Bloc de l'Entraîneur", phase: "technique", theme: "Topspin", duration: 20, description: "L'entraîneur bloque doucement, le joueur essaie de garder la balle sur la table en frottant.", material: "Balles", level: 'debutant' },
