...
const generateExercises = (): Exercise[] => {
  return [
    ...
    { id: 'ch_c22', name: "Le Joker", phase: "cognitif", theme: "Stratégie", duration: 15, description: "Match en 11 points. Chaque joueur a 1 'Joker' pour choisir son côté de service ou annuler un point adverse.", material: "Balles", level: 'debutant' },
