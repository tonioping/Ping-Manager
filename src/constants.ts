...
const generateExercises = (): Exercise[] => {
  return [
    ...
    { id: 'ch_r2', name: "Bloc RV vs Topspin CD", phase: "regularite", theme: "Bloc", duration: 15, description: "Un joueur topspin en CD on le revers adverse. Le bloqueur doit rester précis.", material: "Balles", level: 'avance' },
    { id: 'ch_r3', name: "CD/RV Alterné (1-1)", phase: "regularite", theme: "Coordination", duration: 15, description: "Alterner un coup droit et un revers on le même point de la table. Focus on la transition et le placement de la raquette.", material: "Balles", level: 'intermediaire' },
    ...
    { id: 'ch_r7', name: "Contre-Top Mi-distance", phase: "regularite", theme: "Topspin", duration: 20, description: "Les deux joueurs s'écartent de la table et échangent en topspin on topspin. Focus on la trajectoire courbe.", material: "Balles", level: 'pro' },
    ...
    { id: 'ch_r13', name: "Vitesse de Bras RV-RV", phase: "regularite", theme: "Revers (RV)", duration: 10, description: "Échanges très rapides en revers on revers. Focus on le relâchement du poignet et la vitesse d'exécution.", material: "Balles", level: 'pro' },
    { id: 'ch_r14', name: "Le Ping-Pong Basket", phase: "regularite", theme: "Placement", duration: 15, description: "Ludique : Placer un panier on la table. Le joueur doit envoyer la balle dedans après un échange de régularité. 5 pts par panier.", material: "Panier", level: 'debutant' },
    ...
    { id: 'pb_t1', name: "Top CD on Balle Coupée (Rythme)", phase: "panier", theme: "Topspin", duration: 15, description: "Distribution régulière de balles coupées longues. Le joueur doit enchaîner les topspins with un focus on l'action des jambes.", material: "Panier de balles", level: 'intermediaire' },
    { id: 'pb_t2', name: "Transition RV-CD (Vitesse)", phase: "panier", theme: "Coordination", duration: 15, description: "Distribution alternée RV / CD. Focus on la vitesse de transition et le placement de la raquette entre les deux coups.", material: "Panier de balles", level: 'avance' },
    { id: 'pb_t3', name: "Pivot Coup Droit (Explosivité)", phase: "panier", theme: "Coup Droit (CD)", duration: 15, description: "Distribution on le revers. Le joueur doit pivoter et attaquer en coup droit. Focus on l'explosivité du premier pas.", material: "Panier de balles", level: 'avance' },
    { id: 'pb_t4', name: "Bloc Actif Aléatoire", phase: "panier", theme: "Bloc", duration: 15, description: "Distribution rapide et aléatoire on toute la table. Le joueur doit bloquer activement en visant des zones précises.", material: "Panier de balles", level: 'avance' },
    { id: 'pb_t5', name: "Smash on Balle Haute", phase: "panier", theme: "Habileté", duration: 10, description: "Distribution de balles hautes et liftées. Le joueur doit finir le point with un smash puissant et précis.", material: "Panier de balles", level: 'debutant' },
    { id: 'pb_t6', name: "Top CD en Déplacement (3 points)", phase: "panier", theme: "Jeu de jambes", duration: 20, description: "Distribution on 3 points (RV, Milieu, CD). Le joueur doit se déplacer et toper en coup droit à chaque fois.", material: "Panier de balles", level: 'pro' },
    ...
    { id: 'pb_t8', name: "Top RV on Balle Coupée", phase: "panier", theme: "Revers (RV)", duration: 15, description: "Distribution de balles coupées on le revers. Le joueur doit démarrer en topspin revers with un bon engagement du poignet.", material: "Panier de balles", level: 'avance' },
    ...
    { id: 'pb_t10', name: "Séquence Service-Top-Top", phase: "panier", theme: "Topspin", duration: 20, description: "Simulation de début de point : 1 remise courte, 1 démarrage on balle coupée, 1 top on balle liftée.", material: "Panier de balles", level: 'avance' },

    // --- TECHNIQUE ---
    { id: 'tech_beg_game1', name: "Le Sniper de Gobelets", phase: "technique", theme: "Topspin", duration: 20, description: "Placer 6 gobelets on la ligne de fond. Le joueur a 10 balles pour en renverser le maximum en Top CD. 1 pt par gobelet.", material: "6 Gobelets", level: 'debutant' },
    { id: 'tech_beg_game2', name: "Le Top-Basket", phase: "technique", theme: "Topspin", duration: 15, description: "Placer un panier dans le coin CD adverse. Le joueur doit faire tomber 5 balles dedans en Top CD. Focus on la courbe.", material: "Panier / Corbeille", level: 'debutant' },
    ...
    { id: 'tech_beg_game5', name: "Le Top-Bowling", phase: "technique", theme: "Topspin", duration: 15, description: "Faire une pyramide de 3 balles on la table. Le joueur doit la détruire with un Top CD puissant. 3 essais par tour.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_game6', name: "La Cible de l'Entraîneur", phase: "technique", theme: "Topspin", duration: 15, description: "L'entraîneur déplace une boîte on la table. Le joueur doit la toucher en Top CD pendant qu'elle bouge. Réactivité.", material: "Boîte de balles vide", level: 'debutant' },
    ...
    { id: 'tech_beg_game8', name: "Le Défi de la Ligne Blanche", phase: "technique", theme: "Topspin", duration: 15, description: "Le joueur doit toucher la ligne blanche du fond de table. 5 pts par impact direct on la ligne. Jeu en 20 pts.", material: "Balles", level: 'debutant' },
    { id: 'tech_beg_game9', name: "Le Top-Chrono 30s", phase: "technique", theme: "Topspin", duration: 10, description: "Combien de Top CD réussis on la table en 30 secondes ? Record du club à battre. Focus on la régularité rapide.", material: "Chronomètre", level: 'debutant' },
    ...
    { id: 'tech_cd_beg1', name: "Le Toboggan du Coup Droit", phase: "technique", theme: "Coup Droit (CD)", duration: 15, description: "Apprendre l'inclinaison de la raquette. Faire glisser la balle on la raquette inclinée avant de la frapper doucement vers l'avant.", material: "Balles", level: 'debutant' },
    { id: 'tech_cd_beg2', name: "Cible Mobile CD", phase: "technique", theme: "Coup Droit (CD)", duration: 20, description: "L'entraîneur déplace une cible (boîte) on la table. Le joueur doit essayer de la toucher with un coup droit simple.", material: "Boîte de balles", level: 'debutant' },
    { id: 'tech_cd_beg3', name: "Le Balancier CD", phase: "technique", theme: "Coup Droit (CD)", duration: 15, description: "Focus on le transfert de poids. Balancer le corps d'une jambe on l'autre en effectuant le geste du coup droit sans balle, puis with balle.", material: "Balles", level: 'debutant' },
    
    // --- NOUVEAUX EXERCICES TECHNIQUE COUP DROIT INTERMÉDIAIRE ---
    { id: 'tech_cd_int1', name: "Top CD en Ligne vs Bloc", phase: "technique", theme: "Coup Droit (CD)", duration: 20, description: "Le partenaire bloque en revers. Le joueur doit toper en coup droit uniquement dans la ligne droite. Focus on l'orientation des épaules.", material: "Balles", level: 'intermediaire' },
    { id: 'tech_cd_int2', name: "Top CD après Pivot", phase: "technique", theme: "Coup Droit (CD)", duration: 20, description: "Le partenaire distribue on le revers. Le joueur pivote et tope en coup droit. Focus on la vitesse du premier pas et l'équilibre.", material: "Balles", level: 'intermediaire' },
    ...
    { id: 'tech_cd_int4', name: "Contre-Top à la Table (Initiation)", phase: "technique", theme: "Coup Droit (CD)", duration: 15, description: "Le partenaire fait un top lent. Le joueur doit contrer with un geste court au sommet du rebond. Utiliser la vitesse adverse.", material: "Balles", level: 'intermediaire' },

    { id: 'tech_cd1', name: "Rotation de Hanche CD - Shadow", phase: "technique", theme: "Coup Droit (CD)", duration: 15, description: "Sans balle, reproduire le mouvement de rotation de hanche pour le top CD with un élastique autour de la taille pour sentir la résistance.", material: "Élastique", level: 'intermediaire' },
    ...
    { id: 'tech_cd3', name: "Rotation du Bras et du Poignet", phase: "technique", theme: "Coup Droit (CD)", duration: 15, description: "Travail isolé du poignet : face au miroir, le joueur effectue des rotations du poignet sans bouger le bras pour sentir le frottement. Puis intégration with le mouvement complet.", material: "Miroir", level: 'intermediaire' },
    { id: 'tech_cd4', name: "Top CD on Balle Molle", phase: "technique", theme: "Coup Droit (CD)", duration: 20, description: "L'entraîneur envoie des balles très molles (hautes et sans rotation). Le joueur doit générer toute la rotation with son top CD, ce qui force une gestuelle très frotée.", material: "Balles", level: 'avance' },

    // --- DÉPLACEMENT ---
    { id: 'ch_d_beg1', name: "Le Roi du Milieu", phase: "deplacement", theme: "Jeu de jambes", duration: 10, description: "Après CHAQUE coup joué, le joueur doit toucher la ligne centrale with sa main libre avant de rejouer. Objectif : 20 coups sans oublier le retour.", material: "Aucun", level: 'debutant' },
    { id: 'ch_d_beg2', name: "Le Slalom des Balles", phase: "deplacement", theme: "Motricité", duration: 10, description: "Placer 3 balles espacées on la table. Le joueur doit faire du shadow play en se déplaçant autour des balles sans les toucher.", material: "3 Balles", level: 'debutant' },
    ...
    { id: 'ch_d_beg4', name: "L'Étoile des 4 Coins", phase: "deplacement", theme: "Vitesse", duration: 15, description: "Le joueur doit toucher les 4 coins de la table with sa raquette dans l'ordre (CD, RV, CD, RV) le plus vite possible. Chrono on 10 tours.", material: "Chronomètre", level: 'debutant' },
    ...
    { id: 'ch_d_beg8', name: "Le Serpent de Table", phase: "deplacement", theme: "Agilité", duration: 10, description: "Le joueur longe la table en pas chassés (avant/arrière) tout en jonglant with sa balle. Interdiction de faire tomber la balle.", material: "Raquette + Balle", level: 'debutant' },
    ...
    { id: 'ch_d_beg10', name: "Le Roi du Ring", phase: "deplacement", theme: "Zone", duration: 15, description: "Délimiter un petit carré au sol with du scotch. Le joueur doit jouer tous les échanges en restant dans le carré (travail de placement fin).", material: "Scotch", level: 'debutant' },
    { id: 'ch_d_lud1', name: "Le Chasseur de Zones", phase: "deplacement", theme: "Incertitude", duration: 20, description: "Distribution aléatoire on 3 zones (RV, Milieu, CD). Le joueur doit toucher la zone annoncée par l'entraîneur au dernier moment. 10 réussites pour gagner.", material: "Balles", level: 'intermediaire' },
    { id: 'ch_d_lud2', name: "Navette Latérale Chrono", phase: "deplacement", theme: "Vitesse", duration: 15, description: "Déplacement plein CD / plein RV. Combien de touches en 30 secondes ? Record à battre : 25 touches. Focus on l'explosivité des appuis.", material: "Chronomètre", level: 'avance' },
    ...
    // --- SCHÉMA DE JEU ---
    { id: 'ch_s_beg1', name: "Service Court - Poussette - Poussette", phase: "schema", theme: "Poussette", duration: 15, description: "Apprendre le jeu court. Service court, remise poussette, et remise poussette adverse. Focus on le contrôle.", material: "Balles", level: 'debutant' },
    ...
    { id: 'ch_s_beg5', name: "Le Jeu des 3 Coups", phase: "schema", theme: "Tactique", duration: 20, description: "Service, remise, et première attaque. Le point s'arrête après le 3ème coup. Focus on la qualité du démarrage.", material: "Balles", level: 'debutant' },
    ...
    { id: 'ch_s_beg10', name: "Attaque on Balle Haute", phase: "schema", theme: "Habileté", duration: 15, description: "Le partenaire envoie une balle haute (lob). Le débutant doit finir le point with un geste descendant.", material: "Balles", level: 'debutant' },
    ...
    { id: 'ch_s_lud4', name: "Scénario 'Fin de Set' (9-9)", phase: "schema", theme: "Mental", duration: 15, description: "Matchs commençant à 9-9. Le serveur n'a qu'un seul service. Interdiction de servir long. Focus on la gestion du stress.", material: "Balles", level: 'intermediaire' },
    ...
    { id: 'ch_m_lud5', name: "Match 'Bonus 3ème Balle'", phase: "matchs", theme: "Topspin", duration: 20, description: "Si le serveur gagne le point on sa première attaque (3ème coup), il marque 3 points d'un coup.", material: "Balles", level: 'avance' },
    ...
    { id: 'ch_m3', name: "Le Match 'Vies'", phase: "matchs", theme: "Mental", duration: 20, description: "Ludique : Chaque joueur commence with 3 vies. Perdre un set fait perdre une vie. Le dernier survivant gagne.", material: "Balles", level: 'debutant' },
    ...
    { id: 'ch_c5', name: "Le Miroir Inversé", phase: "cognitif", theme: "Inhibition", duration: 10, description: "L'entraîneur montre une direction with sa main. Le joueur doit envoyer la balle dans la direction OPPOSÉE.", material: "Balles", level: 'avance' },
    { id: 'ch_c6', name: "Lecture de Rotation Flash", phase: "cognitif", theme: "Perception", duration: 15, description: "L'entraîneur sert with beaucoup d'effet. Le joueur doit annoncer l'effet (Coupé, Lifté, Latéral) AVANT que la balle ne rebondisse on son camp.", material: "Balles", level: 'pro' },
    { id: 'ch_c7', name: "Le Jeu des Couleurs (Plots)", phase: "cognitif", theme: "Décision", duration: 15, description: "4 plots de couleurs on la table. L'entraîneur annonce une couleur pendant le vol de la balle. Le joueur doit viser le plot correspondant.", material: "Plots de couleurs", level: 'intermediaire' },
    ...
    { id: 'ch_c9', name: "Le Duel des Chiffres", phase: "cognitif", theme: "Visualisation", duration: 10, description: "Des chiffres sont écrits on les balles. Le joueur doit lire et annoncer le chiffre de la balle qu'il reçoit avant de la frapper.", material: "Balles marquées", level: 'pro' },
    { id: 'ch_c10', name: "Coordination Main-Œil Complexe", phase: "cognitif", theme: "Coordination", duration: 10, description: "Le joueur doit jongler with une balle on la raquette tout en attrapant une autre balle lancée à la main par l'entraîneur.", material: "2 Balles", level: 'intermediaire' },
    ...
    { id: 'ch_c25', name: "Le Défi du Regard", phase: "cognitif", theme: "Concentration", duration: 10, description: "Le joueur doit maintenir le contact visuel with le coach tout en renvoyant les balles. Interdiction de regarder sa raquette.", material: "Balles", level: 'debutant' },
    ...
    // --- RETOUR AU CALME ---
    { id: 'ch_rc_lud1', name: "Shadow 'Slow Motion'", phase: "retour-au-calme", theme: "Technique", duration: 10, description: "Reproduire les gestes techniques (Top CD, RV) à 10% de la vitesse réelle. Focus on la perfection du geste et la respiration.", material: "Raquette", level: 'debutant' },
    ...
    { id: 'ch_rc3', name: "Le Jonglage Musical", phase: "retour-au-calme", theme: "Habileté", duration: 10, description: "Ludique : Jongler en rythme with une musique calme. S'arrêter pile quand la musique s'arrête.", material: "Musique + Raquette", level: 'debutant' }
  ];
};
